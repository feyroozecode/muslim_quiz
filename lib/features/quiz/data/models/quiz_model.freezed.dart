...
class _$QuizModelImpl implements _QuizModel {
  ...
  @override
  String toString() {
    return 'QuizModel(id: $id, question: $question, options: $options, correctOptionIndex: $correctOptionIndex, explanation: $explanation, imageUrl: $imageUrl)';
  }
...
abstract class _QuizModel implements QuizModel {
  const factory _QuizModel(
      ...
      final String? explanation,
      final String? imageUrl}) = _$QuizModelImpl;
